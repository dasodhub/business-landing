...
@section('content')
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">Our Services</h2>
      ...
      @if (count($services) > 0)
            @foreach ($services as $services )
                <article class="flex max-w-xl flex-col items-start justify-between">
                    ...
                    <p class="mt-5 line-clamp-3 text-sm/6 text-gray-600">{{ $services['description'] }}</p>
                    </div>
